...
const CardTittle = React.forwardRef<HTMLParagraphElement,
...
CardTittle.displayName ="CardTittle"
...
export{Card, CardHeader, CardTittle, CardDescription, CardContent, CardFooter}